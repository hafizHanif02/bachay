...
Route::group(['namespace' => 'Admin', 'prefix' => 'admin', 'as' => 'admin.'], function () {
    ...
    Route::group(['middleware' => ['admin']], function () {
        ...
        Route::group(['prefix' => 'banner', 'as' => 'banner.','middleware'=>['module:promotion_management']], function () {
            ...
            Route::post('web/{id}', 'BannerController@IsWeb')->name('web');
            Route::post('mobile/{id}', 'BannerController@IsMobile')->name('mobile');
            ...
            Route::group(['middleware'=>['module:system_settings']],function(){
                ...
                Route::group(['prefix' => 'quiz'],function(){
                    Route::group(['prefix' => 'quiz-category'],function(){
                        Route::get('/', 'BusinessSettingsController@AllQuizCategory')->name('quiz.quiz-category');
                        Route::post('/store', 'BusinessSettingsController@QuizCategoryStore')->name('quiz.quiz-category.store');
                        Route::get('/edit/{id}', 'BusinessSettingsController@QuizCategoryEdit')->name('quiz.quiz-category.edit');
                        Route::post('/update', 'BusinessSettingsController@QuizCategoryUpdate')->name('quiz.quiz-category.update');
                ...
                Route::group(['prefix' => 'quiz'],function(){
                        ...
                        Route::get('/view/{id}', 'BusinessSettingsController@QuizDetail')->name('quiz.view');
                        Route::put('/update/{id}', 'BusinessSettingsController@QuizUpdate')->name('quiz.update');
                        Route::post('/delete', 'BusinessSettingsController@QuizDelete')->name('quiz.delete');

                        Route::group(['prefix' => 'question'],function(){
                            Route::get('/', 'BusinessSettingsController@QuizAllQuestion')->name('quiz.question');
                            Route::post('/store', 'BusinessSettingsController@QuizQuestionStore')->name('quiz.question.store');
                            Route::get('/edit/{id}', 'BusinessSettingsController@QuizQuestionEdit')->name('quiz.question.edit');
                            Route::post('/delete', 'BusinessSettingsController@QuizQuestionDelete')->name('quiz.question.delete');
                        });
                });

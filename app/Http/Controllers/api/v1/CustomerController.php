        ...
        if($child != null){
            ...
            foreach($vaccines as $vaccine){
                ...
                if($ageInMonth < 1){
                    ...
                    $vaccine->ageInWords = '0'.(int)$ageInMonth . ' Months';
                }else{
                    $vaccine->ageInWords = (int)$ageInMonth . ' Months';
                }
            }
                ...
                foreach ($vaccines as $vaccine) {
                    ...
                    foreach($vaccineSubmission as $vaccineSubmission){
                        if($vaccineSubmission->submission_date != null){
                            ...
                            $vaccineSubmission->status = "Upcoming";
                        }elseif(Carbon::parse($vaccineSubmission->Vaccination_date) > $currentDate){
                    ...
                    if (!isset($vaccination_data[$vaccine->ageInWords])) {
                        ...
                        $vaccination_data[$vaccine->ageInWords]['status'] = [];
                    }

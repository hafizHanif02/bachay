                ...
                <div class="checkout_details">
                    ...
                    @if ($physical_product_view)
                        <div class="px-3 px-md-0">
                            <h3 class="textClr pb-2 mt-4 fs-18 text-capitalize ">{{ translate('shipping_address') }}</h3>
                        </div>

                        @php($shipping_addresses = \App\Model\ShippingAddress::where(['customer_id' => auth('customer')->id(), 'is_billing' => 0, 'is_guest' => 0])->get())
                        <form action="" class="card __card" id="shipping_address_form">
                            @csrf
                            <input type="hidden" value="{{ $customer_data->id }}" name="customer_id">
                            <div class="card-body p-0">
                                <ul class="list-group">
                                    <li class="list-group-item pb-3" onclick="anotherAddress()">
                                            ...
                                            <div class="">
                                                <div class="mt-3">
                                                    <div class="row">
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control rounded-pill"
                                                                    ...
                                                                    value="{{ $customer_data->f_name . ' ' . $customer_data->l_name }}"
                                                                    id="name">
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                <label>{{ translate('phone') }}
                                                                    <span class="text-danger">*</span></label>
                                                                <input type="text" class="form-control rounded-pill"
                                                                    name="phone" value="{{ $customer_data->phone }}"
                                                                    id="phone"
                                                                    {{ $shipping_addresses->count() == 0 ? 'required' : '' }}>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control rounded-pill"
                                                                    name="city" value="{{ $customer_data->city }}"
                                                                    id="city"
                                                                    {{ $shipping_addresses->count() == 0 ? 'required' : '' }}>
                                                            </div>
                                                        </div>
                                                                    ...
                                                                    <select name="zip"
                                                                        ...
                                                                        @forelse($zip_codes as $code)
                                                                            <option value="{{ $code->zipcode }}">
                                                                                {{ $code->zipcode }}</option>
                                                                        @empty
                                                                            <option>{{ translate('no_zip_to_deliver') }}
                                                                            </option>
                                                                        @endforelse
                                                                    </select>
                                                                @else
                                                    ...
                                                    <div class="form-group mt-2">
                                                        <input id="pac-input" class="controls rounded-pill ps-2"
                                                    ...
                                                    <button type="button" onclick="SubmitShippingAddress()"
                        ...
                        <form  class="card __card" id="billing_address_form">
                            ...
                            <div id="hide_billing_address" class="">
                                <ul class="list-group">
                                    ...
                                    <li class="list-group-item pb-3" onclick="billingAddress()">
                                        ...
                                        <div id="accordion">
                                            <div class="">
                                                <div class="">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                <label>{{ translate('phone') }}
                                                                    <span class="text-danger">*</span></label>
                                                                <input type="text" class="form-control rounded-pill"
                                                                    total name="billing_phone" id="billing_phone"
                                                        ...
                                                        <div class="col-12">
                                                            <div class="form-group">
                                                                <label>{{ translate('address_type') }}</label>
                                                                <select class="form-control rounded-pill"
                                                                    name="billing_address_type" id="billing_address_type">
                                                                    <option value="permanent">{{ translate('permanent') }}
                                                                    </option>
                                                        ...
                                                        <div class="col-6">
                                                            <div class="form-group">
                                                                ...
                                                                @else
                                                                    <input type="text"
                                                                        class="form-control rounded-pill" id="billing_zip"
                                                    ...
                                                    <div class="form-group mt-2">
                                                        <input id="pac-input-billing" class="ps-2 controls rounded-pill"
                                                            title="{{ translate('search_your_location_here') }}"
                                                            type="text"
                                                            placeholder="{{ translate('search_here') }}" />

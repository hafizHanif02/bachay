...
@include('layouts.front-end.return-detail.first-section')
@include('layouts.front-end.return-detail.payment-info')
@include('layouts.front-end.return-detail.slider')

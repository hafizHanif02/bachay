...
@include('layouts.front-end.guaranteed-savings-offer.banner')

@include('layouts.front-end.guaranteed-savings-offer.kid-style')    
@include('layouts.front-end.guaranteed-savings-offer.benefits-savings')

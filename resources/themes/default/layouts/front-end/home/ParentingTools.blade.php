                ...
                <div class="card card-1">
                    <div class="card-body bg-purple rounded-4">
                        <div class="row">
                            ...
                            <div class="col-12 text-center ">
                                <img
                                    class="mt-5 mb-5 articles-img" src="{{ asset('public/images/Frame (1).png') }}" alt=""
                                    srcset="">
                            </div>
                            <div class="col-12 text-center ">
                ...
                <div class="card card-2">
                    <div class="card-body bg-orange rounded-4">
                        <div class="row">
                            ...
                            <div class="col-12 text-center">
                                <img class="mt-5 mb-5 Contests-img" src="{{ asset('public/images/Group 96.png') }}" alt=""
                                    srcset="">
                            </div>
                            <div class="col-12 text-center ">
                                <a href="#" class="text-white text-decoration-none">
                ...
                <div class="card card-3">
                    <div class="card-body bg-pink rounded-4">
                        <div class="row">
                            ...
                            <div class="col-12 text-center ">
                                <img  class="mt-5 mb-5 Baby-Names-img" src="{{ asset('public/images/vector (1).png') }}" alt=""
                                    srcset="">
                            </div>
                            <div class="col-12 text-center ">
                                <a href="#" class="text-white text-decoration-none">
                ...
                <div class="card card-4">
                    <div class="card-body bg-green rounded-4">
                        <div class="row">
                            ...
                            <div class="col-12 text-center ">
                                <img class="mt-5 mb-5 Meal-Planner-img" src="{{ asset('public/images/Group 97.png') }}" alt=""
                                    srcset="">
                            </div>
                ...
                <div class="card card-5">
                    <div class="card-body bg-yellow rounded-4">
                        <div class="row">
                            ...
                            <div class="col-12 text-center ">
                                <img class="mt-5 mb-5 Vaccinations-img" src="{{ asset('public/images/Group 98.png') }}" alt=""
                                    srcset="">
                            </div>
                            <div class="col-12 text-center ">
                                <a href="#" class="text-white text-decoration-none">

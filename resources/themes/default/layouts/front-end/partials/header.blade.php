                                    ...
                                    <div class="dropdown-content">
                                        <div class="d-flex align-items-center p-0 ps-3 dropdown_item">
                                            <a class="nav-link p-2 text-center" href="{{ route('my-profile') }}">
                                                ...
                                                <svg class="me-3" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person-plus" viewBox="0 0 16 16">
                                ...
                                <div class="d-flex align-items-center ps-3">
                                    ...
                                    <div class="d-flex align-items-center p-0 ps-3">
                                        <a class="nav-link p-2 text-center" href="#">
                                            <svg class="me-3" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-bag-plus" viewBox="0 0 16 16">
                                    ...
                                    <div class="d-flex align-items-center p-0 ps-3">
                                        <a class="nav-link p-2 text-center" href="{{ route('manage-returns') }}">
                                            <svg class="me-3" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-x-octagon" viewBox="0 0 16 16">
                                    ...
                                    <div class="d-flex align-items-center p-0 ps-3">
                                        <a class="nav-link p-2 text-center" href="{{ route('manage-returns') }}">
                                            <svg class="me-3" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-ticket-detailed" viewBox="0 0 16 16">
                                    ...
                                    <div class="d-flex align-items-center p-0 ps-3">
                                        <a class="nav-link megamenu_text p-2 text-center" href="{{ route('manage-returns') }}">
                                            <svg class="me-3" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-return-left" viewBox="0 0 16 16">
                                    ...
                                    <div class="d-flex align-items-center p-0 ps-3">
                                        <a class="nav-link p-2 text-center" href="{{ route('manage-returns') }}">
                                            <svg class="me-3" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-cash" viewBox="0 0 16 16">
                                    ...
                                    <div class="d-flex align-items-center p-0 ps-3">
                                        <a class="nav-link p-2 text-center" href="{{ route('manage-returns') }}">
                                            <svg class="me-3" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-patch-check" viewBox="0 0 16 16">
                                    ...
                                    <div class="d-flex align-items-center p-0 ps-3">
                                        <a class="nav-link p-2 text-center" href="{{ route('my-reviews-upload') }}">
                                            <svg class="me-3" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-star-half" viewBox="0 0 16 16">
                            ...
                            <div class="mega-menu-container">
                                <div class="mega-menu-grid">
                                    ...
                                    <div class="sub-nav-column">
                                        <div class="z-depth-1 polariod">
                                            <img class="object-fit-cover rounded-3"
                                                src="{{ asset('public/images/premium-b-7.webp') }}"
                                                alt="premium image" class="theme responsive-img" width="100%"
                                                height="100%">
                                ...
                                <div class="mega-menu-grid">
                                    <div class="sub-nav-column">
                                        <ul class="collection">
                                            ...
                                            <li><a href="#">Formal & Party Wear <span
                                                        class="color">NEW</span></a>
                                            </li>
                                            <li><a href="#">Booties</a></li>
                                            <li><a href="#">Bellies & Peep Toes <span
                                                        class="color">NEW</span></a>
                                            </li>
                                            <li><a href="#">Sandals</a></li>
                                            <li><a href="#">Clogs</a></li>
                                    ...
                                    <div class="sub-nav-column">
                                        <div class="z-depth-1 polariod">
                                            <img class="object-fit-cover rounded-3"
                                                src="{{ asset('public/images/premium-b-6.webp') }}"
                                                alt="premium 6 image" class="theme responsive-img" width="100%"
                                                height="100%">
                                ...
                                <div class="mega-menu-grid">
                                    ...
                                    <div class="sub-nav-column">
                                        <ul class="collection">
                                            ...
                                            <li><a href="#">Standard Strollers<span
                                                        class="color">NEW</span></a>
                                            </li>
                                            <div class="box"></div>

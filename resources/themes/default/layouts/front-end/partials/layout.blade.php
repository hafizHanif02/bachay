<body>
    <header>
        <div class="desktop-nav">
            ...
            <div class="nav-btn" id="mega-menu" class="hide-on-med-and-down">
                <ul class="sub-nav d-flex justify-content-between pt-4 pb-4">
                ...
                <div class="col list-group">
                    <ul>
                        ...
                        <li class="poppins mt-3"><a href="tel:"
                                ...
                                <h6><i class="bi bi-telephone"></i> </h6>
                            </a></li>
                        <li class="poppins mt-3"><a href="mailto:"
                                class="text-decoration-none">
                                <h6><i class="bi bi-envelope"></i> </h6>
                            </a></li>
                    </ul>
                </div>
            </div>
    ...
    <div class="copyright-con">
        <h5>Copyright &copy; {{ date('Y') }} <span class="clr-head"></span>, All rights
            reserved.</h5>
    </div>

    ...
    <div class="col-8 border-right">
        ...
        <div class="parent-card mt-5 pb-5 col-12 d-flex align-items-center bottom-border gap-3">
            <div class="col-3 for-img">
                <img class="object-fit-cover rounded-3" src="{{ asset('storage/app/public/product/thumbnail/' . $whishlistproduct->product->thumbnail) }}" alt=""
                    width="100%" height="100%">
            </div>
            <div class="col-5 border-right">
                <h5 class="fw-semibold m-0 font-poppins">
                    {{ $whishlistproduct->product->name }}
                </h5>
            ...
            <div class="col-4">
                <h3 class="product-price mb-1">
                    Rs. {{ $whishlistproduct->product->unit_price }}
                </h3>

                <div class="d-flex align-items-center">
                    <h6 class="text-decoration-line-through m-0 discount-off">Rs. {{ $whishlistproduct->product->purchase_price }}</h6>
                    <span class="text-success fw-bold font-poppins"> - {{ $whishlistproduct->product->discount }}% Off</span>
                </div>
        ...
        <div class="d-flex justify-content-between pe-3 mt-3">
            ...
            <div class="returns">
                <img src="{{ asset('public/images/returns.svg') }}" alt=""> <span class="font-poppins"> Hassel
                    Free Returns or Exchange
                </span>
            </div>
            <div class="Handpicked-Products">
                <img src="{{ asset('public/images/hand-product.svg') }}" alt=""> <span
                    class="font-poppins">Handpicked Products</span>
            </div>
            <div class="Exchange">
                <img src="{{ asset('public/images/exchange.svg') }}" alt=""> <span class="font-poppins">Easy

...
{{-- <div class="premiumBouquets p-4">
    <h1 class="text-center textClr pb-5">{{ $data->pageSectionHeading->heading }}</h1>
            ...
            <div class="col-lg-3 col-md-6 col-sm-12 mb-4">
                <div class="card rounded-4 for-border">
                    <a href="{{ $pageSectionCategory->link }}">
                        <img class="card-img rounded-4" src="{{ Storage::url($pageSectionCategory->image) }}"
                            alt="Flash Sale" height="315px" />
                    </a>
                </div>
            </div>
        @endforeach

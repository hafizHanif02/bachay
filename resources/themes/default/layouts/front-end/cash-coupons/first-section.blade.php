        ...
        <div class="profile_content ps-4">
            ...
            <div class="showNow MyAccount font-poppins mt-4">
                <h6 class="fw-normal m-0 rounded-pill text-center text-white">
                    You have <a href="" class="text-pink text-decoration-none fw-semibold">Rs. 256</a> Cash Coupons Avalible
                </h6>
            </div>
                    ...
                    <div class="d-flex align-items-center col-11">
                        <div class="CashCouponsFlat offer col-4 me-2">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="">
                                    <h6 class="fs-20 font-poppins fw-semibold flatss mb-0">FLAT 90% Off</h6>
                                </div>

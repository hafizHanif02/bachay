...
<div class="row col-12 my-cart pb-5 mt-4">
    <div class="col-8 border-right">
        ...
        <div class="btn-con col-12 d-flex justify-content-between mt-4">
            <button class="col-5 mt-2 btn-f rounded-pill p-3 bg-purple border-0 masterCard">
                <img class="object-fit-cover me-2" src="{{ asset('public/images/MasterCardimg.png') }}" alt=""
                    width="100%" height="100%">**** **** **** *014</button>

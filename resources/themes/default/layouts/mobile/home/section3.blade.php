...
<div class="mobileContainer space-between">  
    <div class="slider-nav mt-3">
        ...
        <div class="">
            <a href="#" class="text-decoration-none">
                ...
                <h3 class="text-center gradient-text fs-12">New Season</h3>
            </a>
        </div>
        <div class="">
            <a href="#" class="text-decoration-none">
    ...
    <div class="slider-nav">
        ...
        <div class="">
            <a href="#" class="text-decoration-none">
                <div class="for-sizing">
                <img class="New-Season rounded-circle new-arival-container" src="{{ asset('web/images/kid.png') }}" alt="">
                </div>
                <h3 class="text-center gradient-text fs-12">New Season</h3>
            </a>
        </div>
        <div class="">
            <a href="#" class="text-decoration-none">
                <div class="for-sizing">
                <img class="Gifts rounded-circle new-arival-container" src="{{ asset('web/images/cate-img3.png') }}" alt="">
                </div>
                <h3 class="text-center text-dark fs-12">Gifts <span class="text-success">-15%</span></h3>
            </a>
        </div>
        <div class="">
            <a href="#" class="text-decoration-none">
                <div class="for-sizing">
                <img class="Kids-Accessories rounded-circle new-arival-container" src="{{ asset('web/images/cate-img1.png') }}" alt="">
                </div>
                <h3 class="text-center text-dark fs-12">Kids Accessories</h3>
            </a>
        </div>
        <div class="">
            <a href="#" class="text-decoration-none">
                <div class="for-sizing">
                <img class="Fashion rounded-circle new-arival-container" src="{{ asset('web/images/cate-img4.png') }}" alt="">
                </div>
                <h3 class="text-center text-dark fs-12">Fashion</h3>
            </a>
        </div>
        <div class="">
            <a href="#" class="text-decoration-none">
                <div class="for-sizing">
                <img class="Education rounded-circle new-arival-container" src="{{ asset('web/images/cate-img2.png') }}" alt="">
                </div>
                <h3 class="text-center text-dark fs-12">Education</h3>
            </a>
        </div>

...
<body>
    <div class="d-flex align-items-center mt-3">
        <img class="me-2" src="./left-arrow.svg" alt="" width="20px" height="20px">
        <h6 class="mb-0 fw-semibold">Child Name 01</h6>
    </div>
    ...
    <div class="text-center pt-3">
        ...
        <div class="Profile-name d-flex align-items-center rounded-pill p-3 mt-3">
            ...
            <div>
                <input class="border-0" type="text" placeholder="Enter Child Full Name">
            </div>
        </div>
        ...
        <div class="d-flex align-items-center">
            ...
            <div>
                <input class="profile-details border-0" type="text" placeholder="Enter Weight In Kg">
            </div> 
        </div>
    </div>
    <!-- <div class="profile-Name rounded-pill p-3 mt-3 fw-semibold">13 Kg</div> -->
    <div class="profile-Name rounded-pill p-3 mt-3">
        <p class="mb-0 text-center">ex: 10 <span class="fw-semibold">Kg</span></p>
    </div>
</div>
    <div class=" Profile-name d-flex justify-content-between align-items-center rounded-pill p-3 mt-3">
        <div class="d-flex align-items-center">

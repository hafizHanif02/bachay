                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9 mt-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="{{ translate('enter_tag') }}" name="tags" value="{{ $category->tags == null ? '':implode(', ', json_decode($category->tags)) }}" data-role="tagsinput">
                                    </div>
                                </div>

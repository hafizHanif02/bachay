            ...
            <div class="row align-items-center">
                <div class="col-sm mb-2 mb-sm-0">
                    ...
                    <div class="d-sm-flex align-items-sm-center justify-content-between">
                        <h3 class="page-header-title">User ID #{{$customer['id']}}</h3>
                        ...
                        <span>
                            <a class="btn btn--primary" onclick="printDiv('printableArea')">Add Child from User List</a>
                            <a class="btn btn--primary" href="{{route('admin.customer.parent-add-new-child',[$customer['id']])}}">Add Child as New User</a>
                        </span>
                    </div>
                </div>
            </div>

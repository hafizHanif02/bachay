	...
	<div class="row gx-2 gx-lg-3">
		<div class="col-sm-12 col-lg-12 mb-3 mb-lg-2">
			<div class="card">
				<div class="card-body">
				  <div class="container">
					<form action="{{ route('admin.business-settings.quiz.quiz-category.store') }}" method="post" enctype="multipart/form-data">
						@csrf
						<div class="row g-3">
							<div class="col-md-12">
							...
							<td class="text-center">
								<div class="d-flex justify-content-center gap-2">
									<a class="btn btn-outline--primary btn-sm edit square-btn"
									   ...
									   href="{{ route('admin.business-settings.quiz.quiz-category.edit', $category->id) }}">
										<i class="tio-edit"></i>
									</a>
									<form action="{{route('admin.business-settings.quiz.quiz-category.delete')}}" method="post">
									@csrf
